...
let
  ...
  configAttrs = {
    ...
    # readFiles plus the shared skill manifest: cecli has no native skill
    # loader, so the INDEX.md generated by modules/agent-skills rides along
    # as always-on read-only context.
    read = cfg.readFiles ++ [ "${homeDir}/${agentSkillsRoot}/INDEX.md" ];
  }
  // {
